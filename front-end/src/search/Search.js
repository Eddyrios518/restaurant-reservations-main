...
/** the search component allows the user to search for a specific reservation by entering in a phone number into the search field and display all reservations under the given phone number */
export default function Search() {
    const [mobileNumber, setMobileNumber] = useState("");
    const [reservations, setReservations] = useState([]);
    const [error, setError] = useState(null);

// this updates the state if mobileNumber when the user makes any changes to it
...
function handleSubmit(event) {
    ...
    //this function returns all reservations, if any 
