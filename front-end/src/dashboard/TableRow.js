...
export default function TableRow({ table }) {
    if (!table) return null; // if no table or undefined, return null 
...
/** this displays a single table (row), which is mapped in tablesJSX() in Dashboard. It then displays a list of all tables */
return (
